...
require (
	buf.build/gen/go/tailor-inc/tailor/connectrpc/go v1.19.1-20251215013159-5fcd1dda7d1f.2
	buf.build/gen/go/tailor-inc/tailor/protocolbuffers/go v1.36.11-20251215013159-5fcd1dda7d1f.1
